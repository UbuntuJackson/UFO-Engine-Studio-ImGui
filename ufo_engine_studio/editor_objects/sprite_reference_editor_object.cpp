...
#include "../property.h"
#include "sprite_reference_editor_object.h"

namespace UFOEngineStudio{

SpriteReferenceEditorObject::SpriteReferenceEditorObject(){
    ...
    frame_index = AddConstructorProperty<PropertyInt>("frame index", 0);
}

void SpriteReferenceEditorObject::OnSetupProperty(PropertyFloat *_p){
...
void SpriteReferenceEditorObject::OnSetupProperty(PropertyAssetString* _p){
...
void SpriteReferenceEditorObject::OnSetupProperty(PropertyString* _p){
...
void SpriteReferenceEditorObject::OnSetupProperty(PropertyVector2f* _p){
    ActorEditorObject::OnSetupProperty(_p);
...
void SpriteReferenceEditorObject::OnSetupProperty(PropertyInt* _p){
    ActorEditorObject::OnSetupProperty(_p);
...
void SpriteReferenceEditorObject::Update(ProgramState* _program_state, ActorEditorObject* _parent_editor_object, Vector2f _parent_position){
    ...
    if(frame_index->value < 0) frame_index->value = frames_per_row*frames_per_column-1;
    if(frame_index->value > frames_per_row*frames_per_column-1) frame_index->value = 0;

    int frame_row_number_y = frame_index->value/frames_per_row;
    int frame_column_number_x = frame_index->value%frames_per_row;
